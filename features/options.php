...
class PluginOptions {
	 ...
	 * @var 플러그인 옵션 키값
	 */
	public static $option_key = "rocket_media_library_mime_type";
	...
	public static function get_current_all_options() {
		return shortcode_atts(RocketMediaLibraryMimeType::defaults(), get_option( self::$option_key ));
	}
	...
	public static function update_option_check_match_default($post){
		$options = shortcode_atts(RocketMediaLibraryMimeType::defaults(), self::get_current_all_options());
